...
class DragListWidget(QListWidget):
    def __init__(self, parent=None):
        ...
        self.setMinimumWidth(100)  #  Minimum width
        self._width = 150
...
class JackConnectionManager(QMainWindow):
    def __init__(self):
        ...
        # Set font to bold
        output_label.setFont(font)  # Reuse the same font object
        ...
        #  Fixed width for the middle section
        ...
        # Bottom layout for auto refresh, undo, and redo buttons
        ...
        # Set fixed size for bottom buttons
        ...
        content_layout.addLayout(output_layout)  # No stretch factor
        content_layout.addWidget(middle_layout_widget) # No stretch factor
        content_layout.addLayout(input_layout)   # No stretch factor
